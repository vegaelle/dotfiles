...
themes_dir = (awful.util.getdir("config") .. "/powerarrowf")
...
'<span background="#4B3B51" font="' .. font .. '"><span font="' .. font .. '" color="#EEEEEE"> Vol:$1 </span></span>', 0.3, "-c1 Master")
...
'<span background="#4B696D" font="' .. font .. '"> <span font="' .. font .. '" color="#DDDDDD">$2%<span color="#888888">·</span>$3%<span color="#888888">·</span>$4%<span color="#888888">·</span>$5% </span></span>', 5)
...
awful.key({ modkey }, "l", function() awful.util.spawn("xscreensaver-command -l", false) end),

-- {{ Volume Control }} --

awful.key({     }, "XF86AudioRaiseVolume", function() awful.util.spawn("amixer -c1 set Master 5%+", false) end),
awful.key({     }, "XF86AudioLowerVolume", function() awful.util.spawn("amixer -c1 set Master 5%-", false) end),
awful.key({     }, "XF86AudioMute", function() awful.util.spawn("amixer -c1 set Master toggle", false) end),
